...
SAXONY_CITIES = {
    ...
    "glauchau":"Glauchau","delitzsch":"Delitzsch","torgau":"Torgau",
}
...
CAT_KW = {
    "🍔 Food":         ["food","küche","restaurant","barista","mcdonald","burger","kfc","subway","bäcker","café","cafe","gastronomie","catering","koch","kellner"],
    "🛒 Retail":       ["kasse","supermarkt","retail","verkauf","lidl","rewe","aldi","edeka","zara","h&m","penny","netto","kaufland","verkäufer"],
    ...
    for what, where in SEARCHES:
        try:
            ...
            for item in results:
                ...
                # Use Adzuna redirect URL — goes to exact job listing
...
log.info("Background Adzuna fetcher started...")
